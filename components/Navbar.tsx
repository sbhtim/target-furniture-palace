...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      <div className="bg-[#c9933a] text-[#0a1628] text-center py-1.5 px-4 text-xs font-bold tracking-widest flex items-center justify-center gap-2">
        <Phone size={12} />
        WHATSAPP | CALL 0718 187 545 TO PLACE AN ORDER
      </div>
      <nav className="bg-[#0a1628] flex items-center justify-between px-4 py-3 shadow-lg">
        <button className="text-white p-1 md:hidden" onClick={() => setOpen(!open)}>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href="https://wa.me/254718187545" target="_blank" className="flex items-center gap-2 bg-[#25D366] text-white font-bold text-sm px-4 py-2 rounded-full">
        ...
        {open && (
          <div className="absolute top-full left-0 right-0 bg-[#0a1628] border-t border-white/10 p-6 flex flex-col gap-5 md:hidden">
